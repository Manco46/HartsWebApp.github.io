...
Public Class EmailService
    ...
    Public Function SendAsync(message As IdentityMessage) As Task Implements IIdentityMessageService.SendAsync
        ...
        Dim fromAddress As String = "wojichulumanco@gmail.com"
        ...
        Dim emailMassage As New MailMessage(fromAddress, message.Destination)

        emailMassage.Subject = message.Subject
        emailMassage.Body = message.Body
        emailMassage.BodyEncoding = Encoding.UTF8
        emailMassage.IsBodyHtml = True

        smtpWebMail.Send(emailMassage)
