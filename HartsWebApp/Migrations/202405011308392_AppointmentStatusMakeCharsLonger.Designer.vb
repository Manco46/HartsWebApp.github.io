...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AppointmentStatusMakeCharsLonger
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AppointmentStatusMakeCharsLonger))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202405011308392_AppointmentStatusMakeCharsLonger"
            End Get
        End Property
