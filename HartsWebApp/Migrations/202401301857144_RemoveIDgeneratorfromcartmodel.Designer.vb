...
Namespace Migrations
    ...
    Public NotInheritable Partial Class RemoveIDgeneratorfromcartmodel
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(RemoveIDgeneratorfromcartmodel))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202401301857144_RemoveIDgeneratorfromcartmodel"
            End Get
        End Property
