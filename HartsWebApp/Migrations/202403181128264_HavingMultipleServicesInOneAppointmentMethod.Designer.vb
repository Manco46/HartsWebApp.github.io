...
Namespace Migrations
    ...
    Public NotInheritable Partial Class HavingMultipleServicesInOneAppointmentMethod
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(HavingMultipleServicesInOneAppointmentMethod))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202403181128264_HavingMultipleServicesInOneAppointmentMethod"
            End Get
        End Property
