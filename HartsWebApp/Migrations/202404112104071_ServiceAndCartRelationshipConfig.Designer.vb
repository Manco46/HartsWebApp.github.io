...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ServiceAndCartRelationshipConfig
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ServiceAndCartRelationshipConfig))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202404112104071_ServiceAndCartRelationshipConfig"
            End Get
        End Property
