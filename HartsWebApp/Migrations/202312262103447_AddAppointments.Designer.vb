...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddAppointments
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddAppointments))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202312262103447_AddAppointments"
            End Get
        End Property
