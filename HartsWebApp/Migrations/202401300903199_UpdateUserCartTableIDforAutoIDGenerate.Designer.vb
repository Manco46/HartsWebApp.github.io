...
Namespace Migrations
    ...
    Public NotInheritable Partial Class UpdateUserCartTableIDforAutoIDGenerate
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(UpdateUserCartTableIDforAutoIDGenerate))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202401300903199_UpdateUserCartTableIDforAutoIDGenerate"
            End Get
        End Property
