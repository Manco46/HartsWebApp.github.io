...
Namespace Migrations
    ...
    Public NotInheritable Partial Class DeletingColumnsForReconstructionInServiceSectionTable
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DeletingColumnsForReconstructionInServiceSectionTable))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202403181202169_DeletingColumnsForReconstructionInServiceSectionTable"
            End Get
        End Property
