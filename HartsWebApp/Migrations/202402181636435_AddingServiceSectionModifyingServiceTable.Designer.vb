...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddingServiceSectionModifyingServiceTable
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddingServiceSectionModifyingServiceTable))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202402181636435_AddingServiceSectionModifyingServiceTable"
            End Get
        End Property
