...
Namespace Migrations
    ...
    Public NotInheritable Partial Class CreatingRelationshipBetweenServiceSectionAndService
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(CreatingRelationshipBetweenServiceSectionAndService))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202403181209147_CreatingRelationshipBetweenServiceSectionAndService"
            End Get
        End Property
