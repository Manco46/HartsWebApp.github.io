    ...
    @<div class="form-horizontal">
        ...
        @Html.HiddenFor(Function(model) model.ID)
         ...
         <div class="form-group">
             ...
             <div class="col-md-10">
                 @Html.DropDownListFor(Function(model) model.SectionID, New SelectList(ViewBag.Section, "Value", "Text", ""), "SELECT A SECTION", New With {.class = "form-control", .placeholder = "Gender", .type = "text"})
